...
<!-- Need to avoid execution to deal with noSuggest CMD check -->
<!-- (packages in Suggests need to be used conditionally) -->
<!-- xgxr needed -->
...
```
![](img/fig_basic_workflow_gof.png){width=70%}
...
plot_er_exp_sel(ermod_bin_exp_sel) +
  xgxr::xgx_scale_x_log10()
```
![](img/fig_basic_workflow_exp_sel.png){width=70%}
...
```
![](img/fig_basic_workflow_coveff.png){width=70%}
