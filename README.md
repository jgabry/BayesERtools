...
[![Codecov test
coverage](https://codecov.io/gh/Genentech/BayesERtools/graph/badge.svg)](https://app.codecov.io/gh/Genentech/BayesERtools)
<!-- badges: end -->

BayesERtools provides a suite of tools that facilitate exposure-response
analysis using Bayesian methods.

- Tutorial: <https://genentech.github.io/BayesERbook/>
